  ...
  <section id="container" >
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <header class="header black-bg">
            ...
            <!--logo start-->
            <a href="<?=base_url('index.php/bunga/dashboard')?>" class="logo"><b>Florist</b></a>
            <!--logo end-->
            <div class="top-menu">
      ...
      <aside>
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                      <a href="<?=base_url('index.php/bunga/toko')?>" >
                  ...
                  <li class="sub-menu">
                      <a href="<?=base_url('index.php/bunga')?>" >
                          <i class="fa fa-book"></i>
                          <span>Tipe Bunga</span>
                      </a>
                  </li>
                  <li class="sub-menu">
                      <a href="<?=base_url('index.php/Kategori')?>" >
                          <i class="fa fa-book"></i>
                          <span>Kategori Bunga</span>
                      </a>
                  </li>
                  <?php elseif($this->session->userdata('divisi_bagian')=="Kasir"):?>
                  <li class="sub-menu">
